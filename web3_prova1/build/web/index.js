...
function onMessageReceived(evt) {
    var msg = evt.data;
    strArray = msg;
    strArraySplited = strArray.split(",");
    var total = Number(strArraySplited[strArraySplited.length - 1]);
    var vencedor;
    var percents = new Array();
    strArraySplited.forEach(function (e, i) {
        if (i != strArraySplited.length - 1) {
    ...
    document.getElementById("total").innerHTML = strArraySplited[strArraySplited.length-1];
}
